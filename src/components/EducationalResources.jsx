...
const resources = [
  // YouTube Videos
  {
    ...
    description: "An informative look at the lifecycle of products and the importance of reducing waste in our consumption-driven culture."
  },
  {
    id: 2,
    ...
    description: "Practical tips for beginning your zero waste journey and reducing waste in your daily life."
  },
  {
    id: 3,
    ...
    description: "Learn how Sweden has revolutionized waste management by converting their trash into valuable energy resources."
  },
  {
    id: 4,
    ...
    description: "A detailed explanation of the plastic recycling process and its challenges in the real world."
  },
  {
    id: 5,
    ...
    description: "A step-by-step guide to starting your own composting system at home from Better Homes & Gardens."
  },
  {
    id: 16, 
    ...
    description: "An explanation of the circular economy model and its importance for sustainable waste management."
  },
  ...
  // Websites & Articles
  {
    ...
    thumbnail: "https://www.epa.gov/sites/default/files/styles/large/public/2016-11/recycling_0.jpg",
    description: "Official EPA resources on reducing waste and reusing materials with tips and strategies for individuals and communities."
  },
  {
    id: 7,
    ...
    thumbnail: "https://waste-management-world.com/wp-content/uploads/sites/6/2022/01/AdobeStock_307963120-scaled.jpeg",
    description: "Leading industry publication providing news and information about waste management practices, innovations and technologies worldwide."
  },
  {
    id: 8,
    ...
    description: "Comprehensive database with guides on how to recycle hundreds of different materials, plus a search tool to find local recycling options."
  },
  {
    id: 9,
    ...
    thumbnail: "https://www.wm.com/content/dam/wm/assets/images/sustainability/sustainability-hero.jpg",
    description: "Resources and information from North America's largest environmental solutions provider on sustainable waste management practices."
  },
  {
    id: 10,
    ...
    description: "Practical tips from the EPA on how individuals can reduce waste at home, school, work, in their communities, and while traveling."
  },
  {
    id: 11,
    ...
    thumbnail: "https://www.biocycle.net/wp-content/uploads/2020/07/Compost-pile-with-thermometer-1030x687.jpg",
  ...
  },
  {
    ...
    thumbnail: "https://www.treehugger.com/thmb/iFIoFBxC3_7eIQIKxnPLgwrsGOE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/plastic-recycling-symbols-5c7d4a8646e0fb00017dcd3e.jpg",
  ...
  },
  {
    ...
    description: "Step-by-step instructions for conducting a waste audit in institutional settings."
  },
  {
    id: 14,
    ...
    thumbnail: "https://www.epa.gov/sites/default/files/styles/large/public/2017-12/hazardouswaste.jpg",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
          {resources.map((resource) => {
            ...
            return (
              <div key={resource.id} className={`rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col overflow-hidden ${bgColor} ${borderClass}`}>
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <p className="text-sm text-gray-800 mb-3 flex-grow">{resource.description}</p>

              ...
              <li key={issue._id} className="px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Reported on: {new Date(issue.createdAt).toLocaleDateString()}</p>
                    <p className="text-sm text-gray-500 mt-1">Contact: {issue.user.contactNumber || "1234567890"}</p>
                    <p className="test-sm text-gray-500 mt-1">Email: {issue.user.email || "abc@gmail.com"}</p>

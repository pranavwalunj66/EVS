...
const stories = [
  {
    ...
    testimonial: "Their waste management system has transformed our society. We're proud to be part of this environmental initiative.",
    achievement: "50% reduction in waste sent to landfills"
  },
  {
    society: "Sunrise Apartments",
    testimonial: "The composting program has been a huge success. Our garden has never looked better!",

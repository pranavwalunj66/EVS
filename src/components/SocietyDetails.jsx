...
const SocietyDetails = ({ society, onBack }) => {
    ...
    const wasteTypeData = isSpecificSociety
        ? generateWasteTypeData(society.societyName)
        : { organic: 0, recyclable: 0, nonRecyclable: 0 };
    const efficiencyData = isSpecificSociety
        ? generateEfficiencyData(society.societyName)
        : Array(12).fill(0);
    ...
    const totalWaste =
        monthlyData.organic.reduce((a, b) => a + b, 0) +
    ...
    const recyclingRate = isSpecificSociety
        ? (wasteTypeData.recyclable /
              (wasteTypeData.organic + wasteTypeData.recyclable + wasteTypeData.nonRecyclable)) *
          100
        : 0;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="stat-card">
                            ...
                            <p className="text-2xl font-bold">
                                {isSpecificSociety ? `${totalWaste} kg` : '0 kg'}
                            </p>
                        ...
                        <div className="stat-card">
                            ...
                            <p className="text-2xl font-bold">
                                {isSpecificSociety ? `${recyclingRate.toFixed(1)}%` : '0%'}
                            </p>
                        ...
                        <div className="stat-card">
                            ...
                            <p className="text-2xl font-bold">
                                {isSpecificSociety ? `${avgEfficiency.toFixed(1)}%` : '0%'}
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-gray-600">
                                <span className="font-semibold">Total Families:</span>{' '}
                                {society.totalFamilies}
                            </p>
                        </div>
                        {societyAchievement && (
                            <div>
